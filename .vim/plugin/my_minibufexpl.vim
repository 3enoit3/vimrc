...
function! <SID>RenderSyntax()
  if has("syntax")
    ...
    syn match MBENormal                   ' \[[^\]]*] '
    syn match MBEChanged                  ' \[[^\]]*]\ze&'
    syn match MBENormalSilentChar         '&'

    syn match MBEVisibleNormal            ' \[[^\]]*]\ze='
    syn match MBEVisibleActiveNormal      ' \[[^\]]*]\ze='
    syn match MBEVisibleSilentChar        '='

    syn match MBEVisibleChanged           ' \[[^\]]*]\ze!'
    syn match MBEVisibleActiveChanged     ' \[[^\]]*]\ze!'
    syn match MBEVisibleSilentChar        '!'

    "syn match MBENormal                   '[^]*\ze'
    "syn match MBENormal                   '[^]*\ze'
    "syn match MBENormal                   '[^]*\ze'
...
"    syn match MBEVisibleActiveNormal      '[^]*\ze'
    ...
    "syn match MBEVisibleActiveNormalEnd   '[^]*\zs$'
    "syn match MBENormalEnd                '[^]*\zs$'
...
function! <SID>BuildBufferList(curBufNum)
    ...
    for l:i in s:BufList
        ...
        let l:sumTabWidth += strlen(l:tab)
